 ...
 */
export function mergeFileSummaries(parts: readonly FileSummaries[]): FileSummaries {
  const models: ModelSummary[] = [];
  const slddByName = new Map<string, DataSummary>();
  const matByName = new Map<string, DataSummary>();
 ...
 */
export function buildUsageIndexFromSummaries(summaries: FileSummaries): UsageIndex {
