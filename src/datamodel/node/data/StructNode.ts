 ...
 */
function fieldsOf(rawVal: Record<string, unknown>): string[] {
    if (Array.isArray(rawVal._fields)) {
        return rawVal._fields as string[];
    }
    const elements = rawVal._elements as Record<string, unknown>[] | undefined;
