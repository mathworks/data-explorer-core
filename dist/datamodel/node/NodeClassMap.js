...
const STRUCTURAL_PARSERS = [
    ...
    { matcher: function (val) { return val !== null && typeof val === 'object' && val._array_type === 'String'; }, NodeClass: MatlabVariableNode },
    { matcher: function (val) { return val !== null && typeof val === 'object' && val._array_type === 'Struct'; }, NodeClass: StructNode },
    { matcher: function (val) { return val !== null && typeof val === 'object' && val._array_type === 'Cell'; }, NodeClass: MatlabVariableNode },
    { matcher: function (val) { return val !== null && typeof val === 'object' && !!val._type && !!val._value && typeof val._value === 'string' && val._value.indexOf('Matrix(') === 0; }, NodeClass: MatlabVariableNode },
    { matcher: function (val) { return Array.isArray(val); }, NodeClass: MatlabVariableNode },
    { matcher: function (val) { return val !== null && typeof val === 'object' && !!val._array_class; }, NodeClass: ObjectNode },
    { matcher: function (val) { return val !== null && typeof val === 'object' && !!val._object_class; }, NodeClass: ObjectNode },
...
export function parseValue(rawVal, name, parent) {
    if (rawVal && typeof rawVal === 'object' && rawVal._array_class) {
        ...
        if (elements.length > 1) {
            return ObjectNode.parse(rawVal, name, parent);
        }
        const NodeClass = CLASS_MAP[rawVal._array_class];
        if (NodeClass) {
