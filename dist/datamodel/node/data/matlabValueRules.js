...
export function formatStringElement(el) {
    if (el === null)
...
// rejects outright.
export function classAfterEdit(current, parsedType) {
...
export function elementClass(arrayClass) {
...
export function needsTypedLiteral(type, value) {
...
export function formatMatrix(rows, cols, elements) {
...
export function formatCharMatrix(text, dims) {
    const rows = dims[0];
    const cols = dims[1];
    const rowStrs = [];
    for (let r = 0; r < rows; r++) {
...
export function parseMatrixValue(raw) {
...
//# sourceMappingURL=matlabValueRules.js.map