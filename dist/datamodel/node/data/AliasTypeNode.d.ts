...
export default class AliasTypeNode extends DataNode {
    ...
    static createDefault(name: string, parent: BaseNode | null): AliasTypeNode;
    static parse(rawVal: Record<string, unknown>, name: string, parent: BaseNode | null): AliasTypeNode;
}
//# sourceMappingURL=AliasTypeNode.d.ts.map