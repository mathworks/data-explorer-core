...
function toPropClass(prop, column, editorOverride) {
    const pc = {
        key: prop.key,
...
function resolvePropForKey(className, key) {
...
export function buildPILayout(className) {
...
export function schemaColumns(className) {
...
export function trySetSchemaProperty(node, key, stringValue) {
...
export function schemaColumnLabels() {
    const map = {};
