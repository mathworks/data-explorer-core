 ...
 */
export function summarizeParsedModel(parsed, srcId, filename) {
 ...
 */
export function summarizeSlddScan(scan, srcId, filename) {
    return {
        models: [],
        slddByName: new Map([
            [
 ...
 */
export function summarizeMatScan(scan, srcId, filename) {
    return {
        models: [],
        slddByName: new Map(),
        matByName: new Map([
